	...
	UPackage* Z_Construct_UPackage__Script_Flocking()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_Flocking_Delegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Flocking_AvoidablesDelegate__DelegateSignature,
			};
